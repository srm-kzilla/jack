...
export const INFO = {
    ...
    USER_CHECKIN: (teamName?: string | null) => {
        return {
            title: "You are successfully checked in, kindly check your team channel. 🥳",
  ...
  **Thank you for attending!**
  ...
  `
            ...
            .addFields([
                {
                    name: "Email",
                    value: "Drop your registered email 📨 **below** to **claim** your certificates!",
                },
                {
                    name: "Expiry",
                    value: "This message is only **valid for 5 minutes!** Drop in your email ASAP! ⏱️",
                },
            ])
            .setTimestamp()
            .setFooter(
